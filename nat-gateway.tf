...
resource "aws_eip" "VenturaProd-EIP1" {
  vpc    = true
...
# terraform aws allocate elastic ip
resource "aws_eip" "VenturaProd-EIP2" {
  vpc    = true
...
resource "aws_nat_gateway" "nat-gateway-1" {
  allocation_id = aws_eip.VenturaProd-EIP1.id
...
resource "aws_nat_gateway" "nat-gateway-2" {
  allocation_id = aws_eip.VenturaProd-EIP2.id
...
resource "aws_route_table_association" "private-subnet-1-route-table-association" {
  subnet_id         = aws_subnet.VenturaProdWebSN1.id
...
resource "aws_route_table_association" "private-subnet-3-route-table-association" {
  subnet_id         = aws_subnet.VenturaProdAPPSN1.id
  route_table_id    = aws_route_table.private-route-table-1.id
}

# Associate Private Subnet 5 with "Private Route Table 1"
# terraform aws associate subnet with route table
resource "aws_route_table_association" "private-subnet-5-route-table-association" {
  subnet_id         = aws_subnet.VenturaProdDBSN1.id
  route_table_id    = aws_route_table.private-route-table-1.id
}
...
resource "aws_route_table_association" "private-subnet-2-route-table-association" {
  subnet_id         = aws_subnet.VenturaProdWebSN2.id
...
resource "aws_route_table_association" "private-subnet-4-route-table-association" {
  subnet_id         = aws_subnet.VenturaProdAPPSN2.id
  route_table_id    = aws_route_table.private-route-table-2.id
}

# Associate Private Subnet 6 with "Private Route Table 2"
# terraform aws associate subnet with route table
resource "aws_route_table_association" "private-subnet-6-route-table-association" {
  subnet_id         = aws_subnet.VenturaProdDBSN2.id
  route_table_id    = aws_route_table.private-route-table-2.id
}